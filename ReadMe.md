# 🐾 POKA Friends – 포카(POKA) 캐릭터 탄생 비하인드 웹사이트
...
### Primary Target
- 포카 프렌즈(POKA Friends)의 잠재 팬층
- 캐릭터 굿즈 바이어 및 유통 파트너
- 이커머스 협업 파트너 및 브랜드 관계자
...
| 작업 항목 | 기간 |
|-----------|------|
| 캐릭터 기획 및 세계관 설계 | 1~2일 |
| 스토리 서사 및 UI/UX 구성 | 1일 |
| AI 협업 퍼블리싱 및 디자인 조율 | 1~2일 |
| GitHub Pages 배포 및 테스트 | 1일 |
...
### 2. 브랜드 정체성을 반영한 UI/UX
캐릭터 브랜드 특유의 귀엽고 따뜻한 감성을 웹 인터페이스에 자연스럽게 녹여내어 비주얼과 콘텐츠가 조화롭게 연결되도록 설계했습니다.

### 3. AI 협업 기반 퍼블리싱 (Vibe Coding)
AI와 협업하여 레이아웃, 디자인 방향성, 코드 구조를 빠르게 구현하고 실제 서비스 수준의 퍼블리싱 품질을 완성했습니다.

### 4. 브랜드 콘텐츠 중심 설계
단순 소개 페이지가 아닌, 향후 굿즈·커머스·팬 커뮤니티 확장까지 고려한 **브랜드 콘텐츠 허브** 구조를 목표로 설계했습니다.
